...
lan_ip="192.168.10"                     # LAN 地址 别写后面的 .1
wlan_2g_ssid="rm2100_pdv"               # 2G 无线名称
wlan_5g_ssid="rm2100_pdv_5"             # 5G 无线名称
wlan_guest_2g_ssid="rm2100_pdv_guest"   # 2G 访客无线名称
wlan_guest_5g_ssid="rm2100_pdv_guest_5" # 5G 访客无线名称
